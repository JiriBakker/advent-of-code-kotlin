...
import v2018.Day18.Cell
import v2018.Day18.CellType
...
private object Day18 {
    ...
    class Cell(val x: Int, val y: Int, var type: CellType) {
...
private typealias CellGrid = Array<Array<Cell>>

private fun copyToPrev(grid: CellGrid) {
    grid.forEach { it.forEach { cell -> cell.copyToPrev() } }
}

private fun print(grid: CellGrid) {
    grid.forEach {
        it.forEach { cell ->
...
private fun parse(inputLines: List<String>): CellGrid {
...
private fun updateNeighbours(grid: CellGrid, x: Int, y: Int, updateOperation: (Cell) -> Unit) {
...
private fun iterate(grid: CellGrid, nrOfIterations: Int): Int {
                ...
                if (cell.prevType == CellType.OPEN) {
                    if (cell.prevNrOfWoodedNeighbours >= 3) {
                        ...
                        updateNeighbours(
                            ...
                            cell.x,
                            cell.y
                        ) { it.nrOfOpenNeighbours--; it.nrOfWoodedNeighbours++ }
                    }
                    ...
                    if (cell.prevNrOfLumberyardNeighbours >= 3) {
                        ...
                        updateNeighbours(
                            ...
                            cell.x,
                            cell.y
                        ) { it.nrOfWoodedNeighbours--; it.nrOfLumberyardNeighbours++ }
                    }
                    ...
                    if (!(cell.prevNrOfWoodedNeighbours >= 1 && cell.prevNrOfLumberyardNeighbours >= 1)) {
                        ...
                        updateNeighbours(
                            ...
                            cell.x,
                            cell.y
                        ) { it.nrOfLumberyardNeighbours--; it.nrOfOpenNeighbours++ }
                    }
                }
            }
        }
