...
private object Day20 {
    class Tile private constructor(val id: Long, val grid: List<List<Char>>) {
...
private fun List<List<Day20.Tile>>.combineToImage(): List<List<Char>> {
