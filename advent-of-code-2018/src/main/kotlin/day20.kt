private typealias IntGrid = MutableMap<Int, MutableMap<Int, Int>>
private typealias Index = Int

private fun followDirections(grid: IntGrid, directions: String, startIndex: Int, startX: Int, startY: Int, startPathLength: Int): Index {
    var x = startX
    var y = startY
